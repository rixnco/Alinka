...
CODE_ADDR equ #7e65
	...
	ifndef OBF_DATA_LEN
OBF_DATA_LEN  equ #3b83
	endif

	ifndef OBF_DATA_ADDR
OBF_DATA_ADDR equ #4268
	endif
...
BEGIN	equ OBF_DATA_ADDR
	ORG OBF_DATA_ADDR
	INCBIN "build/data_obf.bin"
...
BEGIN	equ DATA_ADDR
	...
	IFDEF DSK
	IFDEF OBFUSCATED
	SAVE "ALINKA.BIN",BEGIN,END-BEGIN,DSK,"build/alinka_1991.dsk"
	ELSE
	SAVE "ALINKA.BIN",BEGIN,END-BEGIN,DSK,"build/alinka.dsk"
	ENDIF
	ENDIF	;; DSK
	
	IFDEF OBFUSCATED
	SAVE "build/alinka_1991.bin",BEGIN,END-BEGIN
	ELSE
	SAVE "build/alinka.bin",BEGIN,END-BEGIN
	ENDIF
